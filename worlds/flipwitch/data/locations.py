...
witchy_woods_locations = [
    ...
    create_location(LOCATION_CODE_START + witchy_woods_location_start + 47, WitchyWoods.sexual_experience_15, FlipwitchRegion.witch_woods),
...
ghost_castle_locations = [
    ...
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 9, GhostCastle.elf, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 10, GhostCastle.elf_chest, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 11, GhostCastle.garden_key, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 12, GhostCastle.hidden_wall, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 13, GhostCastle.along_path, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 14, GhostCastle.hidden_spring, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 15, GhostCastle.behind_vines, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 16, GhostCastle.across_boss, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 17, GhostCastle.hidden_shrub, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 18, GhostCastle.ghost_form, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 19, GhostCastle.thimble_1, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 20, GhostCastle.thimble_2, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 21, GhostCastle.thimble_chest, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 22, GhostCastle.willow, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 23, GhostCastle.ghost_chaos, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 24, GhostCastle.ghost_mp, FlipwitchRegion.ghost_castle),
    create_location(LOCATION_CODE_START + ghost_castle_location_start + 25, GhostCastle.ghost_gauntlet, FlipwitchRegion.ghost_castle),
]
...
quest_locations = [
    ...
    create_location(LOCATION_CODE_START + quest_location_start + 7, Quest.out_of_service, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 8, Quest.bunny_club, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 9, Quest.silky_slime, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 10, Quest.panty_raid, FlipwitchRegion.ghost_rose),
    create_location(LOCATION_CODE_START + quest_location_start + 11, Quest.unlucky_cat, FlipwitchRegion.jigoku),
    create_location(LOCATION_CODE_START + quest_location_start + 12, Quest.harvest_season, FlipwitchRegion.jigoku),
    create_location(LOCATION_CODE_START + quest_location_start + 15, Quest.long_distance, FlipwitchRegion.angelic_hallway),
    create_location(LOCATION_CODE_START + quest_location_start + 17, Quest.summoning_stones, FlipwitchRegion.slime_citadel),
    create_location(LOCATION_CODE_START + quest_location_start + 18, Quest.semen_with_a, FlipwitchRegion.umi_umi),
    create_location(LOCATION_CODE_START + quest_location_start + 19, Quest.cardio_day, FlipwitchRegion.shady_sewers),
    create_location(LOCATION_CODE_START + quest_location_start + 20, Quest.stop_democracy, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 21, Quest.medical_emergency, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 22, Quest.let_the_dog_out, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 23, Quest.rat_problem, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 24, Quest.ghost_hunters, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 25, Quest.haunted_bedroom, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 26, Quest.ectogasm, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 27, Quest.jelly_mushroom, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 28, Quest.booze_bunny, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 29, Quest.help_wanted, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 30, Quest.deluxe_milkshake, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 31, Quest.boned, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 32, Quest.legendary_chewtoy, FlipwitchRegion.cabaret_cafe),
    create_location(LOCATION_CODE_START + quest_location_start + 33, Quest.tatils_tale, FlipwitchRegion.pig_mansion),
    create_location(LOCATION_CODE_START + quest_location_start + 35, Quest.signing_bonus, FlipwitchRegion.pig_mansion),
    create_location(LOCATION_CODE_START + quest_location_start + 36, Quest.emotional_baggage, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 37, Quest.dirty_debut, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 38, Quest.belles_milkshake, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 39, Quest.devilicious, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 40, Quest.daikon, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 41, Quest.alley_cat, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 42, Quest.whorus, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 43, Quest.priest, FlipwitchRegion.spirit_town),
    create_location(LOCATION_CODE_START + quest_location_start + 44, Quest.goblin_stud, FlipwitchRegion.witch_woods_lower)
]
