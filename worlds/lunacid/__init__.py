...
from .Options import lunacid_options
...
class LunacidWorld(World):
    ...
    option_definitions = lunacid_options
    ...
    def create_item(self, name: str) -> "LunacidItem":
        ...
        return LunacidItem(name, item_table[id]["classification"], item_id, player=self.player)


    def create_event(self, event: str):
        return LunacidItem(event, ItemClassification.progression_skip_balancing, None, self.player)
