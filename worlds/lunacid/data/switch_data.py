...
tomb_lightning_gate_1 = create_switch(189, Switch.tomb_lightning_gate_1, ItemClassification.progression)
tomb_lightning_gate_2 = create_switch(190, Switch.tomb_lightning_gate_2, ItemClassification.progression)
archives_switch = create_switch(191, Switch.archives_switch, ItemClassification.useful)
ballroom_switch = create_switch(192, Switch.ballroom_switch, ItemClassification.useful)
grotto_valve_switch_1 = create_switch(193, Switch.grotto_valve_switch_1, ItemClassification.progression)
grotto_valve_switch_2 = create_switch(194, Switch.grotto_valve_switch_2, ItemClassification.progression)
grotto_calor_switch = create_switch(195, Switch.grotto_calor_switch, ItemClassification.useful)
grotto_temple_switch = create_switch(196, Switch.grotto_temple_switch, ItemClassification.useful)
prison_shortcut_switch = create_switch(197, Switch.prison_shortcut_switch, ItemClassification.progression)
prison_arena_switch = create_switch(198, Switch.prison_arena_switch, ItemClassification.progression)
arena_water_switch = create_switch(199, Switch.arena_water_switch, ItemClassification.useful)
arena_earth_switch = create_switch(200, Switch.arena_earth_switch, ItemClassification.useful)
ash_switch = create_switch(201, Switch.ash_switch, ItemClassification.useful)
