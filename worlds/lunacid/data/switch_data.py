...
tomb_shortcut_switch = create_switch(204, Switch.tomb_shortcut_switch, ItemClassification.useful)
tomb_crypt_switch = create_switch(205, Switch.tomb_crypt_switch, ItemClassification.useful)
tomb_light_switch_1 = create_switch(206, Switch.tomb_light_switch_1, ItemClassification.useful)
tomb_light_switch_2 = create_switch(207, Switch.tomb_light_switch_2, ItemClassification.useful)
tomb_light_switch_3 = create_switch(208, Switch.tomb_light_switch_3, ItemClassification.useful)
archives_switch = create_switch(209, Switch.archives_switch, ItemClassification.useful)
archives_elevator_1_to_2 = create_switch(210, Switch.archives_elevator_switch_1_to_2, ItemClassification.useful)
archives_elevator_2_to_3 = create_switch(211, Switch.archives_elevator_switch_2_to_3, ItemClassification.progression)
archives_elevator_1_to_3 = create_switch(212, Switch.archives_elevator_switch_1_to_3, ItemClassification.progression)
ballroom_switch = create_switch(213, Switch.ballroom_switch, ItemClassification.useful)
grotto_valve_switch_1 = create_switch(214, Switch.grotto_valve_switch_1, ItemClassification.progression)
grotto_valve_switch_2 = create_switch(215, Switch.grotto_valve_switch_2, ItemClassification.progression)
grotto_calor_switch = create_switch(216, Switch.grotto_calor_switch, ItemClassification.useful)
