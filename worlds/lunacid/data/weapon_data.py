...
lyrian_greatsword = create_weapon(109, Weapon.lyrian_greatsword, Elements.normal, Types.melee, ItemClassification.useful)
dark_greatsword = create_weapon(110, Weapon.dark_greatsword, Elements.dark, Types.melee, ItemClassification.useful)
shining_blade = create_weapon(111, Weapon.shining_blade, Elements.light, Types.melee, ItemClassification.useful)
poison_claw = create_weapon(112, Weapon.poison_claw, Elements.poison, Types.melee, ItemClassification.useful)
iron_club = create_weapon(113, Weapon.iron_club, Elements.normal, Types.melee, ItemClassification.useful)
iron_torch = create_weapon(114, Weapon.iron_torch, Elements.fire, Types.melee, ItemClassification.useful)
fire_sword = create_weapon(115, Weapon.fire_sword, Elements.fire, Types.melee, ItemClassification.useful)
steel_lance = create_weapon(116, Weapon.steel_lance, Elements.normal, Types.melee, ItemClassification.useful)
double_crossbow = create_weapon(117, Weapon.double_crossbow, Elements.normal, Types.ranged, ItemClassification.progression)
death_scythe = create_weapon(118, Weapon.death_scythe, Elements.dark_and_light, Types.melee, ItemClassification.useful)
elfen_longsword = create_weapon(119, Weapon.elfen_longsword, Elements.normal, Types.melee, ItemClassification.useful)
flail_beta = create_weapon(120, Weapon.flail, Elements.normal, Types.melee, ItemClassification.useful)
steel_claw = create_weapon(121, Weapon.steel_claw, Elements.normal, Types.melee, ItemClassification.useful)
steel_club = create_weapon(122, Weapon.steel_club, Elements.normal, Types.melee, ItemClassification.useful)
saint_ishii = create_weapon(123, Weapon.saint_ishii, Elements.dark_and_fire, Types.melee, ItemClassification.useful)
silver_rapier = create_weapon(124, Weapon.silver_rapier, Elements.light, Types.melee, ItemClassification.useful)
heritage_sword = create_weapon(125, Weapon.heritage_sword, Elements.normal, Types.melee, ItemClassification.useful)
