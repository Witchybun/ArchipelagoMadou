...
other_drop_locations = [  # The regions and drops are wrong, but are assigned elsewhere
    ...
    LocationData(509, DropLocation.great_bat_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(510, DropLocation.poltergeist_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(511, DropLocation.poltergeist_ectoplasm, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(512, DropLocation.horse_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(513, DropLocation.horse_mana_vial, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(514, DropLocation.hallowed_husk_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(515, DropLocation.hallowed_husk_bones, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(516, DropLocation.hallowed_husk_bandage, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(517, DropLocation.hallowed_husk_light_urn, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(518, DropLocation.hallowed_husk_goldeness, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(519, DropLocation.hallowed_husk_holy_water, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(520, DropLocation.ikkurilb_root, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(521, DropLocation.ikkurilb_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(522, DropLocation.ikkurilb_snowflake_obsidian, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(523, DropLocation.mimic_moon_vial, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(524, DropLocation.mimic_obsidian, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(525, DropLocation.mimic_fools_gold, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(526, DropLocation.obsidian_skeleton_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(527, DropLocation.obsidian_skeleton_bones, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(528, DropLocation.obsidian_skeleton_mana_vial, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(529, DropLocation.obsidian_skeleton_obsidian, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(530, DropLocation.anpu_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(531, DropLocation.anpu_fire_opal, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(532, DropLocation.serpent_antidote, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(533, DropLocation.serpent_5c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(534, DropLocation.embalmed_bandage, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(535, DropLocation.embalmed_ashes, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(536, DropLocation.embalmed_bones, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(537, DropLocation.jailor_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(538, DropLocation.jailor_candle, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(539, DropLocation.jailor_bandage, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(540, DropLocation.jailor_health_vial, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(541, DropLocation.jailor_angel, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(542, DropLocation.lunam_ectoplasm, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(543, DropLocation.lunam_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(544, DropLocation.lunam_snowflake_obsidian, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(545, DropLocation.giant_dark_urn, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(546, DropLocation.giant_bones, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(547, DropLocation.giant_mana_vial, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(548, DropLocation.giant_onyx, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(549, DropLocation.sucsarian_10c, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(550, DropLocation.sucsarian_obsidian, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(551, DropLocation.sucsarian_snowflake_obsidian, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(552, DropLocation.sucsarian_throwing_knife, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(553, DropLocation.vesta_fairy_moss, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(554, DropLocation.vesta_yellow_morel, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(555, DropLocation.vesta_dest_angel, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(556, DropLocation.ceres_fairy_moss, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(557, DropLocation.ceres_yellow_morel, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(558, DropLocation.ceres_dest_angel, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(559, DropLocation.gloom_fairy_moss, LunacidRegion.hollow_basin, Coins.silver),
    LocationData(560, DropLocation.gloom_health_vial, LunacidRegion.hollow_basin, Coins.silver),
