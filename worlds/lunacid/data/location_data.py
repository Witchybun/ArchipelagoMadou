...
boiling_grotto = [
    ...
    LocationData(217, BaseLocation.sand_triple_sarcophagus, LunacidRegion.sand_temple, Coins.silver_5),
]
...
tower_of_abyss = [
    ...
    LocationData(229, BaseLocation.abyss_floor_35, LunacidRegion.tower_abyss, Coins.silver_5),
...
mob_drop_locations = [
    ...
    LocationData(412, DropLocation.chimera_drop, LunacidRegion.forbidden_archives_2, MobSpell.quick_stride),
    LocationData(413, DropLocation.milk_snail_drop, LunacidRegion.hollow_basin, Weapon.ice_sickle),
    LocationData(414, DropLocation.skeleton_weapon_drop, LunacidRegion.fetid_mire, Weapon.skeleton_axe),
