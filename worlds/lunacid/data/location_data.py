...
wings_rest = [
    ...
    LocationData(2, BaseLocation.wings_rest_crystal_shard, LunacidRegion.wings_rest, GenericItem.crystal_shard),
]
...
hollow_basin = [
    ...
    LocationData(5, BaseLocation.hollow_basin_enchanted_door, LunacidRegion.hollow_basin, GenericItem.health_vial),
    LocationData(6, BaseLocation.hollow_basin_left_water, LunacidRegion.hollow_basin, GenericItem.health_vial),
    ...
    LocationData(9, BaseLocation.hollow_basin_right_water_right, LunacidRegion.hollow_basin, GenericItem.mana_vial),
    LocationData(10, BaseLocation.temple_fountain, LunacidRegion.temple_of_silence, GenericItem.health_vial),
    ...
    LocationData(13, BaseLocation.temple_small_pillar, LunacidRegion.temple_of_silence, GenericItem.health_vial),
    LocationData(14, BaseLocation.temple_ritual_ring, LunacidRegion.temple_of_silence, Spell.flame_flare),
    LocationData(15, BaseLocation.temple_pillar_room_back_left, LunacidRegion.temple_of_silence, GenericItem.health_vial),
    LocationData(16, BaseLocation.temple_pillar_room_back_right, LunacidRegion.temple_of_silence, GenericItem.health_vial),
    LocationData(17, BaseLocation.temple_pillar_room_left, LunacidRegion.temple_of_silence, GenericItem.crystal_shard),
...
the_fetid_mire = [
    LocationData(25, BaseLocation.mire_bonerard_trash, LunacidRegion.fetid_mire, GenericItem.antidote),
    LocationData(26, BaseLocation.mire_jellisha_reward, LunacidRegion.fetid_mire, Spell.slime_orb),
    LocationData(27, BaseLocation.mire_jellisha_trash, LunacidRegion.fetid_mire, GenericItem.mana_vial),
    LocationData(28, BaseLocation.mire_rubble_bridge, LunacidRegion.fetid_mire, GenericItem.antidote),
    ...
    LocationData(32, BaseLocation.mire_room_left_foyer, LunacidRegion.fetid_mire, GenericItem.antidote),
    LocationData(33, BaseLocation.mire_rubble_near_illusory_wall, LunacidRegion.fetid_mire, Spell.wind_dash),
    LocationData(34, BaseLocation.mire_underwater_pipe, LunacidRegion.fetid_mire, GenericItem.poison_throwing_knife),
    LocationData(35, BaseLocation.mire_underworks_skeleton, LunacidRegion.fetid_mire, Weapon.broken_hilt),
    LocationData(36, BaseLocation.mire_underworks_waterfall, LunacidRegion.fetid_mire, GenericItem.antidote),
    LocationData(37, BaseLocation.mire_upper_overlook_left, LunacidRegion.fetid_mire, GenericItem.crystal_shard),
...
accursed_tomb = [
    LocationData(44, BaseLocation.catacombs_coffin_stairs, LunacidRegion.accursed_tomb, GenericItem.health_vial),
    ...
    LocationData(52, BaseLocation.mausoleum_maze_intro, LunacidRegion.accursed_tomb, GenericItem.holy_water),
    LocationData(53, BaseLocation.mausoleum_upper_table, LunacidRegion.accursed_tomb, UniqueItem.black_book),
    LocationData(54, BaseLocation.mausoleum_maze_mid, LunacidRegion.accursed_tomb, GenericItem.health_vial),
    LocationData(55, BaseLocation.mausoleum_center_back, LunacidRegion.accursed_tomb, UniqueItem.earth_elixir),
    LocationData(56, BaseLocation.mausoleum_center_right, LunacidRegion.accursed_tomb, GenericItem.health_vial),
    LocationData(57, BaseLocation.mausoleum_center_left, LunacidRegion.accursed_tomb, GenericItem.holy_water),
    LocationData(58, BaseLocation.mausoleum_center_left_path, LunacidRegion.accursed_tomb, GenericItem.health_vial),
    ...
    LocationData(64, BaseLocation.tomb_near_light_switch, LunacidRegion.accursed_tomb, GenericItem.crystal_shard),
...
yosei_forest = [
    ...
    LocationData(67, BaseLocation.yosei_barrels, LunacidRegion.yosei_forest, GenericItem.health_vial),
    ...
    LocationData(71, BaseLocation.yosei_blood_plant_insides, LunacidRegion.yosei_forest, GenericItem.health_vial),
...
forest_canopy = [
    LocationData(76, BaseLocation.canopy_branch_edge, LunacidRegion.forest_canopy, GenericItem.crystal_shard),
...
forbidden_archives = [
    ...
    LocationData(84, BaseLocation.archives_short_wall_near_trees, LunacidRegion.forbidden_archives, GenericItem.health_vial),
    ...
    LocationData(88, BaseLocation.archives_rug_on_balcony, LunacidRegion.forbidden_archives, GenericItem.mana_vial),
    LocationData(89, BaseLocation.archives_hidden_room_lower, LunacidRegion.forbidden_archives, GenericItem.crystal_shard),
    LocationData(90, BaseLocation.archives_near_twisty_tree, LunacidRegion.forbidden_archives, GenericItem.fairy_moss),
...
castle_le_fanu = [
    LocationData(94, BaseLocation.castle_outside_corner, LunacidRegion.castle_le_fanu, GenericItem.mana_vial),
    LocationData(95, BaseLocation.castle_cell_south, LunacidRegion.castle_le_fanu_red, GenericItem.spectral_candle),
    LocationData(96, BaseLocation.castle_cell_west, LunacidRegion.castle_le_fanu_red, GenericItem.health_vial),
    ...
    LocationData(102, BaseLocation.castle_garrat_resting_room_left, LunacidRegion.castle_le_fanu_white, GenericItem.holy_water),
...
sealed_ballroom = [
    LocationData(110, BaseLocation.ballroom_entry_hidden_cave_in_lounge, LunacidRegion.sealed_ballroom, GenericItem.spectral_candle),
    LocationData(111, BaseLocation.ballroom_small_room_lounge, LunacidRegion.sealed_ballroom, GenericItem.blood_wine),
    LocationData(112, BaseLocation.ballroom_entry_long_table, LunacidRegion.sealed_ballroom, GenericItem.health_vial),
    LocationData(113, BaseLocation.ballroom_entry_hidden_couch_top, LunacidRegion.sealed_ballroom, Weapon.steel_needle),
    LocationData(114, BaseLocation.ballroom_entry_hidden_couch_bottom, LunacidRegion.sealed_ballroom, GenericItem.health_vial),
    LocationData(115, BaseLocation.ballroom_side_chest_near_switch, LunacidRegion.sealed_ballroom, Spell.earth_thorn),
    LocationData(116, BaseLocation.ballroom_side_hidden_casket_room, LunacidRegion.sealed_ballroom, GenericItem.health_vial),
    LocationData(117, BaseLocation.ballroom_side_hidden_cave, LunacidRegion.sealed_ballroom, GenericItem.crystal_shard),
...
great_well_surface = [
    LocationData(122, BaseLocation.surface_demi_gift, LunacidRegion.great_well_surface, GenericItem.crystal_shard)
]
...
boiling_grotto = [
    LocationData(124, BaseLocation.grotto_slab_of_bridge, LunacidRegion.boiling_grotto, GenericItem.crystal_shard),
    LocationData(125, BaseLocation.grotto_triple_secret_chest, LunacidRegion.boiling_grotto, GenericItem.ashes),
    LocationData(126, BaseLocation.grotto_hidden_chest, LunacidRegion.boiling_grotto, GenericItem.moonlight_vial),
    LocationData(127, BaseLocation.grotto_rocks_near_lava_switch, LunacidRegion.boiling_grotto, Spell.rock_bridge),
    LocationData(128, BaseLocation.grotto_through_switch_tunnel, LunacidRegion.boiling_grotto, GenericItem.mana_vial),
    LocationData(129, BaseLocation.sand_room_buried_in_sand, LunacidRegion.sand_temple, GenericItem.health_vial),
    ...
    LocationData(136, BaseLocation.sand_second_floor_dead_end, LunacidRegion.sand_temple, GenericItem.health_vial),
]

tower_of_abyss = [
    LocationData(137, BaseLocation.abyss_prize, LunacidRegion.tower_abyss, Weapon.moonlight),
    LocationData(138, BaseLocation.abyss_floor_5, LunacidRegion.tower_abyss, GenericItem.mana_vial),
    LocationData(139, BaseLocation.abyss_floor_10, LunacidRegion.tower_abyss, GenericItem.antidote),
    LocationData(140, BaseLocation.abyss_floor_15, LunacidRegion.tower_abyss, GenericItem.fairy_moss),
    LocationData(141, BaseLocation.abyss_floor_20, LunacidRegion.tower_abyss, GenericItem.spectral_candle),
    LocationData(142, BaseLocation.abyss_floor_25, LunacidRegion.tower_abyss, GenericItem.health_vial),
    ...
    LocationData(145, BaseLocation.abyss_floor_40, LunacidRegion.tower_abyss, GenericItem.spectral_candle),
...
terminus_prison = [
    ...
    LocationData(149, BaseLocation.prison_f3_locked_right, LunacidRegion.terminus_prison, GenericItem.ashes),
    ...
    LocationData(153, BaseLocation.prison_f2_jailer_table, LunacidRegion.terminus_prison_dark, GenericItem.ashes),
    ...
    LocationData(156, BaseLocation.prison_f1_hidden_cell, LunacidRegion.terminus_prison_dark, GenericItem.health_vial),
    LocationData(157, BaseLocation.prison_f4_hanging, LunacidRegion.terminus_prison, GenericItem.health_vial),
    ...
    LocationData(160, BaseLocation.prison_f4_monk_room_three, LunacidRegion.terminus_prison, Alchemy.moonpetal),
    LocationData(161, BaseLocation.prison_f4_jailer_break_room, LunacidRegion.terminus_prison, GenericItem.mana_vial),
    LocationData(162, BaseLocation.prison_f4_hidden_beds, LunacidRegion.terminus_prison, GenericItem.holy_water),
    ...
    LocationData(165, BaseLocation.prison_b2_bone_pit, LunacidRegion.terminus_prison_dark, GenericItem.health_vial),
    LocationData(166, BaseLocation.prison_b2_deep_alcove, LunacidRegion.terminus_prison_dark, UniqueItem.earth_elixir),
    LocationData(167, BaseLocation.prison_b2_guarded_corner_one, LunacidRegion.terminus_prison_dark, GenericItem.moonlight_vial),
    LocationData(168, BaseLocation.prison_b2_guarded_corner_two, LunacidRegion.terminus_prison_dark, GenericItem.moonlight_vial),
]

forlorn_arena = [
    LocationData(169, BaseLocation.arena_rock_parkour, LunacidRegion.forlorn_arena, GenericItem.health_vial),
    LocationData(170, BaseLocation.arena_water_room_near_water, LunacidRegion.forlorn_arena, GenericItem.fairy_moss),
    LocationData(171, BaseLocation.arena_water_dead_end_near_water, LunacidRegion.forlorn_arena, GenericItem.antidote),
    LocationData(172, BaseLocation.arena_water_collapsed_end_near_balcony, LunacidRegion.forlorn_arena, GenericItem.health_vial),
    LocationData(173, BaseLocation.arena_water_hidden_alcove_before, LunacidRegion.forlorn_arena, GenericItem.health_vial),
...
labyrinth_of_ash = [
    LocationData(181, BaseLocation.ash_entry_coffin, LunacidRegion.labyrinth_of_ash, GenericItem.mana_vial),
    LocationData(182, BaseLocation.ash_jotunn_remains, LunacidRegion.labyrinth_of_ash, GenericItem.health_vial),
    LocationData(183, BaseLocation.ash_cetea_statue, LunacidRegion.labyrinth_of_ash, GenericItem.wisp_heart),
