...
venus = create_enemy(Enemy.venus, [LunacidRegion.yosei_lower, LunacidRegion.yosei_forest, LunacidRegion.forest_canopy, LunacidRegion.earth_temple_secret])
...
lupine_skeleton = create_enemy(Enemy.lupine_skeleton, [LunacidRegion.terminus_prison_upstairs, LunacidRegion.terminus_prison])
infested_corpse = create_enemy(Enemy.infested_corpse, [LunacidRegion.terminus_prison_dark])
giant_skeleton = create_enemy(Enemy.giant_skeleton, [LunacidRegion.terminus_prison_dark])
sucsarian_spear = create_enemy(Enemy.sucsarian_spear, [LunacidRegion.forlorn_arena])
sucsarian_dagger = create_enemy(Enemy.sucsarian_dagger, [LunacidRegion.forlorn_arena])
