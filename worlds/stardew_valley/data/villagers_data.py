...
hoe = villager("Haley", True, town, "Spring", universal_loves | haley_loves - prismatic_shard, True, None)
...
penny = villager("Penny", True, town, "Fall", universal_loves | penny_loves - rabbit_foot, True, None)
